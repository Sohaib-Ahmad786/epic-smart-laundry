  ...
  return (
    <div className="fixed inset-0 z-[-10] overflow-hidden pointer-events-none bg-transparent">
      ...
      <motion.div
        ...
        className="absolute top-0 left-[-10%] w-[600px] h-[600px] rounded-full bg-secondary/20 blur-[120px]"
      />
      <motion.div
        animate={{ scale: [1, 1.4, 1], opacity: [0.1, 0.25, 0.1], x: [0, -50, 0] }}
        transition={{ duration: 20, repeat: Infinity, ease: "linear", delay: 2 }}
        className="absolute bottom-[-10%] right-[-10%] w-[800px] h-[800px] rounded-full bg-blue-500/15 blur-[150px]"
      />
    </div>
  );
}
