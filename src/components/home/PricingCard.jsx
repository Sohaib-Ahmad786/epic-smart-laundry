  ...
  return (
    ...
    >
      ...
      >
        ...
        <ul className="space-y-4 mb-8 flex-1 relative z-10" role="list">
        ...
        <Link
          href="/book-order"
          className={cn(
            "w-full py-4 rounded-2xl font-bold text-sm transition-all duration-300 relative z-10 flex items-center justify-center gap-2 group/btn active:scale-[0.98]",
            isPopular
