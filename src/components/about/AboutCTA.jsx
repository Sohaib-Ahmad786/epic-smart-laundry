        ...
        >
          ...
          <div className="relative z-10 px-6 py-20 md:py-24 text-center max-w-4xl mx-auto flex flex-col items-center">
            ...
            <h2 className="text-4xl md:text-5xl font-extrabold text-primary mb-6 tracking-tight">
              Experience Smart Laundry <br />
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-secondary to-blue-600">Service Today</span>
            </h2>
            
            <p className="text-lg text-slate-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Join hundreds of happy customers. Let us handle the dirty work while you focus on what really matters.
            </p>
            ...
            <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto">
              ...
              <Link 
                ...
                target="_blank"
                className="w-full sm:w-auto px-8 py-4 bg-[#25D366]/10 text-[#25D366] font-bold rounded-2xl hover:bg-[#25D366]/20 transition-all duration-300 flex items-center justify-center gap-2"
              >
