...
import { ShieldCheck, Clock, CheckCircle2, MessageCircle } from "lucide-react";
import Container from "../common/Container";

const benefits = [
  { icon: ShieldCheck, title: "Secure Tracking", desc: "Encrypted details protect your privacy." },
  { icon: Clock, title: "Real-Time Updates", desc: "Live status changes as they happen." },
  { icon: CheckCircle2, title: "Quality Checked", desc: "Every step verified for premium care." },
  { icon: MessageCircle, title: "24/7 Support", desc: "Rider and support just a click away." }
];

export default function TrackingBenefits() {
  return (
